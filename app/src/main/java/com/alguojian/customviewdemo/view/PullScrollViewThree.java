 ...
 * @date 2013-09-13
 */
public class PullScrollViewThree extends ScrollView {
    ...
    public PullScrollViewThree(Context context) {
        super(context);
        init(context, null);
    }

    public PullScrollViewThree(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PullScrollViewThree(Context context, AttributeSet attrs, int defStyle) {
